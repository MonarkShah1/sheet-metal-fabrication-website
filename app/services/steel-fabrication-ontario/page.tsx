...
const SERVICE = 'steel-fabrication';
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      type: 'website',
      images: [{
        url: `/images/services/steel-fabrication-ontario-hero.jpg`,
        width: 1200,
        height: 630,
        alt: 'Steel Fabrication Services in Ontario'
      }]
    },
    twitter: {
...
export default function SteelFabricationOntarioPage() {
  const serviceLocation = getServiceLocationBySlug(SERVICE, LOCATION, serviceLocationCombinations);
  ...
  const breadcrumbItems = [
    ...
    { name: 'Steel Fabrication Ontario' }
  ];
      ...
      <section className="py-16 bg-blue-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">
            Get Your Free Steel Fabrication Quote Today
          </h2>
          <p className="text-xl mb-8 text-blue-100">
            Ready to discuss your steel fabrication needs in Ontario? 
